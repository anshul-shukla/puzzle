...
angular.module('puzzleApp')
    .service('service', [function($scope,$mdToast) {
        ...
        service.words = [ "add","sum","took","too","the","tree","dog","doors","table","tables", "of", "and", "to", "in", "is", "you","fog","follow","god","good","goods","gold","trees", "that", "it", "he", "was", "for", "on", "are", "as", "with", "his", "they", "at", "be", "this", "have", "from", "or", "one", "had", "by", "word", "but", "not", "what", "all", "were", "we", "when", "your", "can", "said", "there", "use", "an", "each", "which", "she", "do", "how", "their", "if", "will", "up", "other", "about", "out", "many", "then", "them", "these", "so", "some", "her", "would", "make", "like", "him", "into", "time", "has", "look", "two", "more", "write", "go", "see", "number", "no", "way", "could", "people", "my", "than", "first", "water", "been", "call", "who", "oil", "its", "now", "find", "long", "down", "day","people","elephant","ugly", "did", "get", "come", "made", "may", "part" ];
        service.players =  [{
            name: "Anshul",
            score: 0,
            active: true,
